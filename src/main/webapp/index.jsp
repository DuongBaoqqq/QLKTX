...
<div class="container-xxl position-relative bg-white d-flex p-0">
    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                <a href="${pageContext.request.contextPath}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
    ...
    <div class="content">
        ...
        <div>
            <h1>Hello mate! My dear <%=request.getSession().getAttribute("username")%></h1>
            <p>Welcome to Dormitory management</p>
        </div>
